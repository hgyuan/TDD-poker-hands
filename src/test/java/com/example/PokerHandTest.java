...
public class PokerHandTest {
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_3H_3S_3C_6H_8H_and_white_4D_4S_4C_6C_7D() {
    //given
    String[] black = {"3H", "3S", "3C", "6H", "8H"};
    String[] white = {"4D", "4S", "4C", "6C", "7D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_3H_3S_3C_6H_8H_and_white_3D_4D_5S_6C_7D() {
    //given
    String[] black = {"3H", "3S", "3C", "6H", "8H"};
    String[] white = {"3D", "4D", "5S", "6C", "7D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_black_wins_when_play_given_black_3H_3S_6C_6H_8H_and_white_2D_4D_5S_6S_7D() {
    //given
    String[] black = {"3H", "3S", "6C", "6H", "8H"};
    String[] white = {"2D", "4D", "5S", "6S", "7D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_black_wins_when_play_given_black_3H_3S_6C_6H_2H_and_white_3C_3D_5S_5H_2D() {
    //given
    String[] black = {"3H", "3S", "6C", "6H", "2H"};
    String[] white = {"3C", "3D", "5S", "5H", "2D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_tie_when_play_given_black_3H_3S_6C_6H_2H_and_white_3C_3D_6S_6D_2D() {
    //given
    String[] black = {"3H", "3S", "6C", "6H", "2H"};
    String[] white = {"3C", "3D", "6S", "6D", "2D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_black_wins_when_play_given_black_3H_3S_6C_6H_5H_and_white_3C_3D_6S_6D_4D() {
    //given
    String[] black = {"3H", "3S", "6C", "6H", "5H"};
    String[] white = {"3C", "3D", "6S", "6D", "4D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_3H_3S_6C_6H_5H_and_white_4C_3D_4S_6D_4D() {
    //given
    String[] black = {"3H", "3S", "6C", "6H", "5H"};
    String[] white = {"4C", "3D", "4S", "6D", "4D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_black_wins_when_play_given_black_3H_3S_7C_6H_5H_and_white_2C_3D_4S_6D_7D() {
    //given
    String[] black = {"3H", "3S", "7C", "6H", "5H"};
    String[] white = {"2C", "3D", "4S", "6D", "7D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
  ...
  @Test
  public void should_return_white_wins_when_play_given_black_3H_3S_7C_6H_5H_and_white_2C_2D_4S_4D_8D() {
    //given
    String[] black = {"3H", "3S", "7C", "6H", "5H"};
    String[] white = {"2C", "2D", "4S", "4D", "8D"};
    //when
    PokerHand pokerHand = new PokerHand();
    String result = pokerHand.play(black, white);
